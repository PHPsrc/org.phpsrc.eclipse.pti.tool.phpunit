...
public class OpenEditorAtLineAction extends OpenEditorAction {
	...
	public OpenEditorAtLineAction(TestRunnerViewPart testRunner, String filePath, int line) {
		super(testRunner, filePath);
		PlatformUI.getWorkbench().getHelpSystem().setHelp(this, IPHPUnitHelpContextIds.OPENEDITORATLINE_ACTION);
		fLineNumber = line;
	}
